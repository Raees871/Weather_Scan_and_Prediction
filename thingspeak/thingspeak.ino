...
#define BLYNK_TEMPLATE_ID "TMPL3w10b-ZeH" // replace this with template id
...
char auth[] = "rR77wS4efVyPWAgoQHS1uVfUwz6PpCPA"; // replace this with your auth token
char ssid[] = "VM"; // replace this with your wifi name (SSID)
char pass[] = "connect1234"; // replace this with your wifi password
long myChannelNumber = 2400443;
const char myWriteAPIKey[] = "0ETYAAA4D388BUAR";
